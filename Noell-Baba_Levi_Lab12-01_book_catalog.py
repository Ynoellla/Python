#!/usr/bin/env python3
#Levi Noell-Baba, July 18, 2023, CPT-168-W17, Lab 12-1
...
def list_books(book_catalog): #function to list the books
    for title, book_info in book_catalog.items(): #for loop that goes through each book title and its information in the book_catalog 
        print(f"Title: {title}") #prints the title of the book
        print(f"Author: {book_info['author']}") #prints the author of the book
        print(f"Pub Year: {book_info['pubyear']}") #prints the pubyear of the book
        print()
...
def main():
    ...
    while True:
        ...
        elif command == "list": #added list command that lists the books in book_catalog
